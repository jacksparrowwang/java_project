    ...
    <script type="text/javascript">
        $(function() {
            $("#query").click(function () {
                ...
                alert("pro: "+province+"   sc: "+sc+"   cl: "+cl);
                $.ajax({
            ...
            $("#addClass").click(function () {
                ...
                for (var i in classIds) {
                    if (classIds[i].checked) {
                        listClassId.push(classIds[i].value);
                    }
                }
                alert("listClassId" + listClassId);
                console.log(listClassId+"------");
                for (var i in listClassId) {
                    console.log(listClassId[i]);
                }
                $.ajax({
                    contentType: "application/x-www-form-urlencoded;chartset=utf-8",
                    scriptCharset: 'utf-8',
                    url: "/addClassIdOfTeacher",
                    type: "POST",
                    dataType: "JSON",
                    data: {
