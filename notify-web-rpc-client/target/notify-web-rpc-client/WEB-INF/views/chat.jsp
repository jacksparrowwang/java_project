...
<div class="qqBox">
    <div class="context">
        ...
        <div class="conRight">
            <div class="Righthead">
                <div class="headName">${sessionScope.username}</div>
            </div>
            <div class="RightCont">
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        webSocket = new WebSocket('ws://localhost:8080/webSocket?username=' + '${sessionScope.username}');
    } else {
    ...
    webSocket.onmessage = function (event) {
        ...
        if (undefined != msg.message)
            ...
            setMessageInnerHTML(msg.message);

        if (undefined != msg.onlineName) {
            console.log(msg.onlineName);
            $.each(msg.onlineName, function (key, value) {
                var htmlstr = '<li>'
